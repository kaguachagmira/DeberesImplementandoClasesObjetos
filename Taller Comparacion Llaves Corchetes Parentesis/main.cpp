 ...
 * Tema de Proyecto: Facturacion de Compra Boletos de CINE              *
 * Autores: Kevin Guachagmira, Cristian Barragan,  Jonathan Altamirano  *                    
 * Fecha de inicio: 13/11/2017	Fecha de modificacion: 26/11/2017       *
                    ...
                    while(letra!=13)
                    {
                           fflush(stdin);
                            if(letra!=13)
                            {
                                printf("%c",letra);
                                fflush(stdin);
                                listadoble.insertarInicio(letra);
                            }
